# Write function to automate plotting residual vs predictor plot
# - Plots standard residual vs predictor plot for assessing linear model fits

function plot_residual_predictor(;model, df, y, x)
    ...
    if distType == "Normal{Float64}"
        ...
        # Extract vector of predictor (X) variable
        predictor = df[!, x]
        ...
        p = Gadfly.plot(
            ...
            Gadfly.Guide.xlabel("Predictor variable", orientation=:horizontal),
